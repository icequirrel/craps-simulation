...
public class TestCraps
{
	...
	public TestCraps()
	{
		...
		//game = new CrapsGame(new CrookedDie2(), new CrookedDie1()); // two "unfair" Die objects
		//game = new CrapsGame(new Die(), new CrookedDie1()); // one "unfair" Die objects
		//game = new CrapsGame(new Die(), new CrookedDie2()); // one "unfair" Die objects
